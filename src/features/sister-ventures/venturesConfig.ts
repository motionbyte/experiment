...
/** Default: same app path (override with VITE_SCORE_URL / VITE_VERSE_URL for another host) */
export const SCORE_URL = envScore?.trim() || "/score";

/** Default: in-app The Lost Verse page */
export const VERSE_URL = envVerse?.trim() || "/the-lost-verse";
